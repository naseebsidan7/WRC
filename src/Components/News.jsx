...
export default function NewsSection() {
  ...
  return (
    <div className="dark:bg-black bg-white text-black dark:text-white pt-20 py-12  flex flex-col gap-6 items-center  relative " id="news">
         <div className="flex flex-col items-center gap-4">
            <h2 className="text-3xl font-semibold font-numans">WRC Latest News</h2>
            ...
            >
              ...
              <div className="p-4 flex flex-col relative gap-5">
                  <div>
                      ...
                      <p className="text-[16px] text-gray-800 dark:text-gray-200 font-inter mt-8">{news.description}</p>
